...
#' @param xlim Maximum x-axis value.
#' @param ylim Maximum y-axis value.
#' @param file_prefix Fullpath plus prefix of filename of manhattan and/or qq
#'   plot/s.
...
#' @param cex.axis Same as the plot parameter.
#' @param main Same as the plot parameter.
#' @param y_tickmarks Vector of values for the y-axis.
#' @param y_tickmark_labels Vector of values to use as labels of the
#'   y-tickmarks.
#' @param manhattan Set to TRUE to plot the manhattan plot.
#' @param qq Set to TRUE to plot the qq plot.
#'
#' @export
mxr_manhattan <- function(p_values = "",
                      chr = "CHR",
                      bp = "BP",
                      p = "P",
                      snp = "SNP",
   ...
   if (qq) {
      ...
      qq(data[, c(p)],
         ...
         las = 1, bty = "l", cex.axis = cex.axis, yaxt = "n",
         main = main, xlab = "", ylab = "")
      abline(0,1)
